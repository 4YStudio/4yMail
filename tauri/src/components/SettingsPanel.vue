...
function handleTestError() {
  if (window.electronAPI && window.electronAPI.testConnectionError) {
    window.electronAPI.testConnectionError()
  }
}

function handleTestClearCache() {
  if (window.electronAPI && window.electronAPI.testClearCache) {
    window.electronAPI.testClearCache()
  }
}

function handleTestOpenLogs() {
  if (window.electronAPI && window.electronAPI.testOpenLogs) {
    window.electronAPI.testOpenLogs()
  }
}
</script>
